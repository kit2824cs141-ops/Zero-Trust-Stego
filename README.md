...
Build the WebAssembly binaries formatted for web target usage:
...
Frontend Interface & DOM Core: Yew (Rust)

Package Tooling & DOM Binding: wasm-bindgen, wasm-pack

Pixel Manipulation: image crate
